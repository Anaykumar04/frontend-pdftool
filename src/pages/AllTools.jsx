...
const allTools = [
  ...
  },
  {
    ...
    tools: [
      { to: '/tools/jpg-to-pdf', icon: '🖼️', label: 'JPG to PDF', desc: 'Convert JPG/PNG images to PDF', color: 'bg-teal' },
    ...
    <div className="section">
      <div className="container">
        <div className="section-header">
          ...
          <p>Everything you need to work with PDF files — 100% free, fast, and secure. No account required.</p>
        </div>

        {allTools.map((cat) => (
          <div key={cat.category} style={{ marginBottom: 48 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
              <h2 style={{ fontSize: '1.1rem', fontWeight: 600, color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>{cat.category}</h2>
        ...
        <div style={{ marginTop: 16 }}>
          ...
          <div className="tools-grid">
            {['Combine to Single Page', 'Remove Blank Pages', 'PDF Repair', 'Flatten PDF'].map(name => (
